...
export class GraphHistoryCoordinator {
   ...
   */
  executeAtomicOperation(graph: Graph, _operationType: string, operation: () => any, _options?: any): any {
   ...
   */
  executeCompoundOperation(graph: Graph, _operationType: string, operation: () => any, _options?: any, _additionalOptions?: any): any {
    // Simply execute the operation without history coordination
    return operation();
  }
   ...
   */
  executeVisualEffect(graph: Graph, _effectName: string, operation: () => void): void {
    // Simply execute the operation without history coordination
    operation();
  }
   ...
   */
  getDefaultOptionsForOperation(_operationType: string): any {
    return {
   ...
   */
  shouldExcludeAttribute(_attributePath: string, _options?: any): boolean {
    return false;
  }
}
