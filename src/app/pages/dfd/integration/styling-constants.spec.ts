...
describe('DFD Integration - Styling Constants', () => {
  describe('Styling Constants Validation', () => {
    ...
    it('should have valid hover styling constants', () => {
      ...
      const selectionOpacity = parseFloat(DFD_STYLING.SELECTION.GLOW_COLOR.match(/[\d.]+\)$/)?.[0] || '0');
    ...
    it('should have valid creation effect constants', () => {
      ...
      expect(DFD_STYLING.CREATION.GLOW_BLUR_RADIUS).toBeGreaterThan(DFD_STYLING.SELECTION.GLOW_BLUR_RADIUS);
    });
    ...
    it('should have valid edge constants', () => {
      ...
      expect(DFD_STYLING.EDGES.SELECTION_BLUR_RADIUS).toBeLessThan(DFD_STYLING.SELECTION.GLOW_BLUR_RADIUS);
    });
    ...
    it('should have valid z-order constants', () => {
      ...
      expect(DFD_STYLING.Z_ORDER.NODE_DEFAULT).toBeGreaterThan(DFD_STYLING.Z_ORDER.SECURITY_BOUNDARY_DEFAULT);
    });
  ...
  describe('Type Safety and Constants Integrity', () => {
    it('should maintain type safety for all constants', () => {
      ...
      const validNodeTypes: NodeType[] = ['actor', 'process', 'store', 'security-boundary', 'text-box'];
