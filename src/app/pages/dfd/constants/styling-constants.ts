...
export const DFD_STYLING_HELPERS = {
  ...
  getHoverFilter(nodeType: string): string {
    ...
    return DFD_STYLING.HOVER.FILTER_TEMPLATE(
      blurRadius,
  ...
  getCreationFilter(opacity: number): string {
    ...
    return DFD_STYLING.CREATION.FILTER_TEMPLATE(
  ...
  getDefaultStroke(nodeType: NodeType): string {
    switch (nodeType) {
      case 'actor': return DFD_STYLING.NODES.ACTOR.STROKE;
      case 'process': return DFD_STYLING.NODES.PROCESS.STROKE;
      case 'store': return DFD_STYLING.NODES.STORE.STROKE;
      case 'security-boundary': return DFD_STYLING.NODES.SECURITY_BOUNDARY.STROKE;
      case 'text-box': return DFD_STYLING.NODES.TEXT_BOX.STROKE;
      default: return DFD_STYLING.DEFAULT_STROKE;
    }
  },
  ...
  getDefaultStrokeWidth(nodeType: NodeType): number {
    switch (nodeType) {
      case 'actor': return DFD_STYLING.NODES.ACTOR.STROKE_WIDTH;
      case 'process': return DFD_STYLING.NODES.PROCESS.STROKE_WIDTH;
      case 'store': return DFD_STYLING.NODES.STORE.STROKE_WIDTH;
      case 'security-boundary': return DFD_STYLING.NODES.SECURITY_BOUNDARY.STROKE_WIDTH;
      case 'text-box': return DFD_STYLING.NODES.TEXT_BOX.STROKE_WIDTH;
      default: return DFD_STYLING.DEFAULT_STROKE_WIDTH;
    }
  },
  ...
  getDefaultFill(nodeType: NodeType): string {
    switch (nodeType) {
      case 'actor': return DFD_STYLING.NODES.ACTOR.FILL;
      case 'process': return DFD_STYLING.NODES.PROCESS.FILL;
      case 'store': return DFD_STYLING.NODES.STORE.FILL;
      case 'security-boundary': return DFD_STYLING.NODES.SECURITY_BOUNDARY.FILL;
      case 'text-box': return DFD_STYLING.NODES.TEXT_BOX.FILL;
      default: return DFD_STYLING.DEFAULT_FILL;
    }
  },
} as const;
