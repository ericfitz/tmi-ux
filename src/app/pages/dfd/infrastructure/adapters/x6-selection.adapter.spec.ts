...
describe('X6SelectionAdapter', () => {
  ...
  beforeEach(() => {
    ...
    adapter = new X6SelectionAdapter(mockLogger as any, selectionService);
  ...
  describe('Rubberband Multi-Selection and Blank Click', () => {
    ...
    it('should support multi-selection via selection API', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Selected cells', { count: 2 });
    });
    ...
    it('should select all cells in graph', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Selected all cells', {
    ...
    it('should clear selection programmatically', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Selection cleared');
    });
  });
  ...
  describe('Copy/Paste Functionality', () => {
    ...
    it('should paste cells using SelectionService for position calculation', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Pasted cells', { count: 2 });
    });
    ...
    it('should handle paste with no cells', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('No cells to paste');
    });
  ...
  describe('Alignment and Distribution Operations', () => {
    ...
    it('should align nodes using SelectionService calculations', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Aligned nodes', {
        alignment: 'left',
        count: 3,
      });
    });
    ...
    it('should distribute nodes using SelectionService calculations', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Distributed nodes', {
  ...
  describe('Grouping Operations', () => {
    ...
    it('should group selected nodes using SelectionService logic', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Created group with nodes', {
        groupId: 'group-1',
        nodeCount: 2,
      });
    });
    ...
    it('should not group when SelectionService validation fails', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Cannot group selected nodes');
    });
    ...
    it('should ungroup selected nodes using SelectionService logic', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Ungrouped node', {
  ...
  describe('Selection Mode Control', () => {
    it('should enable selection mode', () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith('Selection mode enabled');
    });
    ...
    it('should disable selection mode', () => {
      ...
      expect(adapter.clearSelection).toHaveBeenCalledWith(graph);
      expect(mockLogger.info).toHaveBeenCalledWith('Selection mode disabled');
    });
  });
});
