...
describe('X6GraphAdapter', () => {
  ...
  describe('Node Creation', () => {
    it('should create an Actor node with correct positioning and styling', () => {
      // Create NodeData with 'actor' shape (matches X6 shape registration)
    ...
    it('should create a Security Boundary node with correct positioning and styling', () => {
      // Create NodeData with 'security-boundary' type, but manually set shape to match X6 expectations
      const nodeData = new NodeData(
        'boundary-1',
        'security-boundary', // This should match X6 shape name
        { x: 50, y: 50 },
        { width: 300, height: 200 },
        { text: { text: 'Trust Boundary' } },
        {},
        1,
        true,
        [{ key: 'type', value: 'security-boundary' }],
      );
    ...
    it('should handle node z-order correctly for different node types', () => {
      const boundaryData = NodeData.create({
        id: 'boundary-1',
      ...
      const processData = NodeData.create({
        id: 'process-1',
        type: 'process',
        label: 'Process',
        position: { x: 50, y: 50 },
      ...
      const textData = NodeData.create({
        id: 'text-1',
        type: 'text-box',
        label: 'Text',
  ...
  describe('Edge Creation', () => {
    it('should create edges between nodes with port connections', () => {
      const sourceData = NodeData.create({
        id: 'source-1',
        type: 'actor',
        label: 'Source',
        position: { x: 100, y: 100 },
      ...
      const targetData = NodeData.create({
        id: 'target-1',
        type: 'process',
        label: 'Target',
  ...
  describe('Graph Navigation', () => {
    it('should support pan and zoom operations', () => {
      const nodeData1 = NodeData.create({
        id: 'node-1',
        type: 'actor',
        label: 'Node 1',
        position: { x: 100, y: 100 },
      ...
      const nodeData2 = NodeData.create({
        id: 'node-2',
        type: 'process',
        label: 'Node 2',
        position: { x: 300, y: 100 },
