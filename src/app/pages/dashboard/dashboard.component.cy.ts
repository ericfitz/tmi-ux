      ...
      of([
        {
          ...
          issue_uri: mockThreatModel1.issue_uri,
          document_count: mockThreatModel1.documents?.length ?? 0,
          source_count: mockThreatModel1.repositories?.length ?? 0,
        ...
        },
        {
          ...
          issue_uri: mockThreatModel2.issue_uri,
          document_count: mockThreatModel2.documents?.length ?? 0,
          source_count: mockThreatModel2.repositories?.length ?? 0,
        ...
        },
        {
          ...
          issue_uri: mockThreatModel3.issue_uri,
          document_count: mockThreatModel3.documents?.length ?? 0,
          source_count: mockThreatModel3.repositories?.length ?? 0,
