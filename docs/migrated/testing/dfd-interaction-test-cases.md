...
**Status**: Verified and Migrated
**Last Updated**: 2026-01-25
**Migrated to**: [TMI Wiki - Testing](https://github.com/ericfitz/tmi/wiki/Testing#dfd-graph-interaction-tests)
...
Location: E2E tests planned for future implementation
...
> **Note**: Cypress E2E tests for DFD are not yet implemented. Current tests use Vitest with JSDOM for integration testing.
...
- Min zoom: 0.5× (50%)
- Max zoom (auto-fit): 1.25× (125%), (manual): 3.0× (300%)
...
> **Note**: Test fixtures directory is planned but not yet implemented. Test data is currently created programmatically within test files.
