...
OUTPUT_PATH = Path(__file__).resolve().parent.parent / 'src' / 'assets' / 'cwe' / 'cwe-699.json'
VIEW_ID = '699'
...
def main() -> None:
    ...
    print(f'Found {len(member_ids)} members in CWE-{VIEW_ID} view (including categories)')
